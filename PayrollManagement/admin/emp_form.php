                    ...
                    <form method="post" id="emp-form" role="form" action="form_action.php">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                            ...
                            <input type="text" name="province" required class="form-control" placeholder="Ontario">
                            <div class="help-block with-errors"></div>
                          </div>
                        </div>
                      </div> <!-- /row -->
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label>city</label>
                            <input type="text" name="city" class="form-control" placeholder="Brampton" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
