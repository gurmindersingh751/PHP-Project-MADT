                  ...
                  if(count($data) != 0){
                    foreach ($data as $key => $datalist) {
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                              <a href="edit_employees_data.php?id=<?=base64_encode($datalist['employee_id'])?>" class="btn btn-info" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                              <a href="employee_delete.php?id=<?=$datalist['employee_id']?>" class="btn btn-danger" title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                          </div>
                          <hr>
